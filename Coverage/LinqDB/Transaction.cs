    ...
    public class Transaction {
        ...
        public void Transactionログ1(){
            ...
            var rnd = new Random(1);
            {
                ...
                Assert.AreEqual(expected,新規Container.dbo.Entity1.Count);
                Assert.AreEqual(expected,新規Container0.dbo.Entity1.Count);
                新規Container.Commit();
                //w0.Close();
                s0.Close();
                ...
                Assert.IsTrue(復元Container.dbo.Entity1.SetEquals(新規Container.dbo.Entity1));
                Assert.AreEqual(復元Container.dbo.Entity1.GetInformation(),新規Container.dbo.Entity1.GetInformation());
                var 復元Container0 = 復元Container.Transaction();
                Assert.IsTrue(復元Container0.dbo.Entity1.SetEquals(新規Container0.dbo.Entity1));
                Assert.IsTrue(復元Container.dbo.Entity1.SetEquals(新規Container.dbo.Entity1));
                Assert.AreEqual(復元Container0.dbo.Entity1.GetInformation(),新規Container0.dbo.Entity1.GetInformation());
                Assert.AreEqual(復元Container.dbo.Entity1.GetInformation(),新規Container.dbo.Entity1.GetInformation());
                復元Container0.Commit();
                Assert.IsTrue(復元Container0.dbo.Entity1.SetEquals(新規Container0.dbo.Entity1));
                Assert.IsTrue(復元Container.dbo.Entity1.SetEquals(新規Container.dbo.Entity1));
        ...
        public void Transactionログ2() {
            ...
            for(var a = 0;a<Writers.Length;a++) {
                ...
                Assert.AreEqual(0,actual.dbo.Entity1.LongCount());
                Assert.AreEqual(0,actual.dbo.Entity2.LongCount());
                Assert.AreEqual(1,actual0.dbo.Entity1.LongCount());
                Assert.AreEqual(2,actual0.dbo.Entity2.LongCount());
                actual0.Commit();
                Assert.AreEqual(1,actual.dbo.Entity1.LongCount());
                Assert.AreEqual(2,actual.dbo.Entity2.LongCount());
                Assert.AreEqual(1,actual0.dbo.Entity1.LongCount());
                Assert.AreEqual(2,actual0.dbo.Entity2.LongCount());
                actual.Commit();
                //actual.dbo.Entity1.Assign(共通(actual,dbo.Entity1_Count1));
                //actual.dbo.Entity2.Assign(共通(actual,dbo.Entity2_Count1));
                //Assert.AreEqual(dbo.Entity1_Count1,actual.dbo.Entity1.LongCount());
                //Assert.AreEqual(dbo.Entity2_Count1,actual.dbo.Entity2.LongCount());
                //w0.Close();
                s0.Close();
                var s1 = new FileStream(ファイル名,FileMode.Open,FileAccess.ReadWrite);
                //var r1 = new BinaryReader(s1,Encoding.UTF8);
                ...
                Assert.IsTrue(expected.dbo.Entity1.SetEquals(actual.dbo.Entity1));
                Assert.IsTrue(expected.dbo.Entity2.SetEquals(actual.dbo.Entity2));
                var expected0 = expected.Transaction();
                Assert.IsTrue(expected0.dbo.Entity1.SetEquals(actual0.dbo.Entity1));
                Assert.IsTrue(expected0.dbo.Entity2.SetEquals(actual0.dbo.Entity2));
                Assert.IsTrue(expected.dbo.Entity1.SetEquals(actual.dbo.Entity1));
                Assert.IsTrue(expected.dbo.Entity2.SetEquals(actual.dbo.Entity2));
                expected0.Commit();
                Assert.IsTrue(expected.dbo.Entity1.SetEquals(actual.dbo.Entity1));
                Assert.IsTrue(expected.dbo.Entity2.SetEquals(actual.dbo.Entity2));
                Assert.IsTrue(expected0.dbo.Entity1.SetEquals(actual.dbo.Entity1));
                Assert.IsTrue(expected0.dbo.Entity2.SetEquals(actual.dbo.Entity2));
                expected.Commit();
                //w1.Close();
                //r1.Close();
                s1.Close();
        ...
        public void TransactionCommit() {
            ...
            var expected2 = 共通(e0,1);
            {
                ...
                Assert.IsTrue(expected1.SetEquals(e0.dbo.Entity1));
                Assert.IsTrue(expected2.SetEquals(e0.dbo.Entity2));
                Assert.IsFalse(expected1.SetEquals(e.dbo.Entity1));
                Assert.IsFalse(expected2.SetEquals(e.dbo.Entity2));
            }
            e0.Commit();
            Assert.IsTrue(expected1.SetEquals(e.dbo.Entity1));
            Assert.IsTrue(expected2.SetEquals(e.dbo.Entity2));
        }
    }
}
