...
public class Unary : 共通
{
    ...
    public void Serialize()
    {
        ...
        this.ExpressionシリアライズAssertEqual(Expression.Decrement(Constant1_1d));
        this.ExpressionシリアライズAssertEqual(Expression.Increment(Constant1_1d));
        this.ExpressionシリアライズCoverage(Expression.PostDecrementAssign(ParameterInt32));
        this.ExpressionシリアライズCoverage(Expression.PostIncrementAssign(ParameterInt32));
        this.ExpressionシリアライズCoverage(Expression.PreDecrementAssign(ParameterInt32));
        this.ExpressionシリアライズCoverage(Expression.PreIncrementAssign(ParameterInt32));
        ...
        this.ExpressionシリアライズAssertEqual(Expression.Decrement(Constant演算子));
        this.ExpressionシリアライズAssertEqual(Expression.Increment(Constant演算子));
        this.ExpressionシリアライズCoverage(Expression.PostDecrementAssign(Parameter演算子));
        this.ExpressionシリアライズCoverage(Expression.PostIncrementAssign(Parameter演算子));
        this.ExpressionシリアライズCoverage(Expression.PreDecrementAssign(Parameter演算子));
        this.ExpressionシリアライズCoverage(Expression.PreIncrementAssign(Parameter演算子));
