...
public class FormatterResolver : 共通
{
    ...
    public void GetFormatter0()
    {
        ...
        this.AssertEqual((Q.IGrouping<int, int>)new Set<int>().GroupBy(p => p).SingleOrDefault());
        ...
        this.AssertEqual((S.IEnumerable<int>)new Set<int>());
        ...
        this.AssertEqual((E.IEnumerable<int>)new Set<int>());
        //        do{
