...
public class FormatterResolver:共通{
    [Fact]public void GetFormatter0(){
        ...
        this.MemoryMessageJson_T_Assert(new S.Set<Tables.Table>());
        //if(type.IsDisplay())return Return(Formatters.Others.DisplayClass<T>.Instance);
        this.MemoryMessageJson_T_Assert(ClassDisplay取得());
        //if(type.IsArray) {
        this.MemoryMessageJson_T_Assert(new Tables.Table[10]);
        //}else if(type.IsGenericType) {
        //    if(type.IsAnonymous()) {
        this.MemoryMessageJson_T_Assert(new{a=1});
        ...
        this.MemoryMessageJson_T_Assert(new S.Set<int>().GroupBy(p=>p).SingleOrDefault());
        ...
        this.MemoryMessageJson_T_Assert((System.Linq.IGrouping<int,int>)new S.Set<int>().GroupBy(p=>p).SingleOrDefault());
        ...
        this.MemoryMessageJson_T_Assert((LinqDB.Sets.IEnumerable<int>)new S.Set<int>());
        ...
        this.MemoryMessageJson_T_Assert((System.Collections.Generic.IEnumerable<int>)new S.Set<int>());
        //        do{
        //            if((Formatter_T=RegisterType(type0,typeof(Enumerables.GroupingList<, >)))is not null)return Formatter_T;
        this.MemoryMessageJson_T_Assert(new LinqDB.Sets.GroupingSet<int,int>(1));
        this.MemoryMessageJson_T_Assert(new LinqDB.Enumerables.GroupingList<int,int>(1));
        ...
        this.MemoryMessageJson_T_Assert(new LinqDB.Sets.SetGroupingList<int,int>());
        //            if((Formatter_T=RegisterType(type0,typeof(Sets.SetGroupingSet     <, >)))is not null)return Formatter_T;
        this.MemoryMessageJson_T_Assert(new LinqDB.Sets.SetGroupingSet<int,int>());
        //            if((Formatter_T=RegisterType(type0,typeof(Sets.Set                <,,>)))is not null)return Formatter_T;
        this.MemoryMessageJson_T_Assert(new LinqDB.Sets.Set<Keys.Key,Tables.Table,LinqDB.Databases.Container>());
    }
    [Fact]public void GetFormatter1(){
        //            if((Formatter_T=RegisterType(type0,typeof(Sets.Set                <, >)))is not null)return Formatter_T;
        this.MemoryMessageJson_T_Assert(new LinqDB.Sets.Set<Keys.Key,Tables.Table>());
        //            if((Formatter_T=RegisterType(type0,typeof(Sets.Set                <  >)))is not null)return Formatter_T;
        this.MemoryMessageJson_T_Assert(new LinqDB.Sets.Set<Tables.Table>());
        //            do{
    ...
    public void GetFormatter_RegisterInterface(){
        ...
        this.MemoryMessageJson_T_Assert(GroupBy.SingleOrDefault());
        //}
        this.MemoryMessageJson_T_Assert((S.IEnumerable<Tables.Table>)new S.Set<Tables.Table>());
        //foreach(var Interface in type.GetInterfaces()){
        //    if(!Interface.IsGenericType)continue;
        //    if(Interface.GetGenericTypeDefinition()==検索したいキーGenericInterfaceDefinition){
        this.MemoryMessageJson_T_Assert(new S.Set<Tables.Table>().GroupBy(p => p).SingleOrDefault());
        //    }
        this.MemoryMessageJson_T_Assert((E.IEnumerable<Tables.Table>)new S.Set<Tables.Table>());
        //}
        this.MemoryMessageJson_T_Assert((Q.IGrouping<int,int>)GroupBy.SingleOrDefault());
        this.MemoryMessageJson_T_Assert(ValueTuple.Create<Q.IGrouping<int,int>>(GroupBy.SingleOrDefault()));
    }
}
