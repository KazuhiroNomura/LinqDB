...
public class FormatterResolver:共通{
    ...
    public void GetFormatter_RegisterInterface(){
        ...
        //this.MemoryMessageJson_Assert(GroupBy.SingleOrDefault());
        //this.MemoryMessageJson_Assert(ValueTuple.Create(GroupBy.SingleOrDefault()));
        //this.MemoryMessageJson_Assert(ValueTuple.Create(new S.Set<Tables.Table>()));
        //this.MemoryMessageJson_Assert(new S.Set<Tables.Table>());
        ////this.MemoryMessageJson_Assert(new{a=new S.Set<Tables.Table>()});
        ////return null;
        ////this.MemoryMessageJson_Assert(new{a=(S.IEnumerable<Tables.Table>)new S.Set<Tables.Table>()});
        //this.MemoryMessageJson_Assert(GroupBy.SingleOrDefault());
        //}else{
