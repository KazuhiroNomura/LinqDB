    ...
    class Class0:IMemoryPackable<Class0>{
        ...
        public static void RegisterFormatter(){
            if(!MemoryPackFormatterProvider.IsRegistered<Class0>()) {
                MemoryPackFormatterProvider.Register(new MemoryPack.Formatters.MemoryPackableFormatter<Class0>());
            }
            if(!MemoryPackFormatterProvider.IsRegistered<Class0[]>()) {
                MemoryPackFormatterProvider.Register(new MemoryPack.Formatters.ArrayFormatter<Class0>());
            }
        }
