...
[Serializable,MessagePackObject(true),MemoryPackable]
public partial struct StructCollection:ICollection<int>{
...
#pragma warning disable MEMPACK006 // MemoryPackObject's constructor has no matched parameter
    public class_演算子オーバーロード(int 内部の値,bool 内部のBoolean,string Stringプロパティ){
        this.内部の値=内部の値;
        this.内部のBoolean=内部のBoolean;
        this.Stringプロパティ=Stringプロパティ;
        this.Int32フィールド=0;
    }
#pragma warning restore MEMPACK006 // MemoryPackObject's constructor has no matched parameter
    ...
    public static class_演算子オーバーロード operator~(class_演算子オーバーロード a)=>new(~a.内部の値,a.内部のBoolean,a.Stringプロパティ);
    public static class_演算子オーバーロード operator!(class_演算子オーバーロード a)=>new(-1^a.内部の値,!a.内部のBoolean,a.Stringプロパティ);
    ...
    public static class_演算子オーバーロード operator++(class_演算子オーバーロード a)=>new(a.内部の値+1,true,a.Stringプロパティ);
    public static class_演算子オーバーロード operator--(class_演算子オーバーロード a)=>new(a.内部の値-1,true,a.Stringプロパティ);
    public static class_演算子オーバーロード operator-(class_演算子オーバーロード a)=>new(-a.内部の値,a.内部のBoolean,a.Stringプロパティ);
    public static class_演算子オーバーロード operator+(class_演算子オーバーロード a)=>new(a.内部の値,a.内部のBoolean,a.Stringプロパティ);
    public static class_演算子オーバーロード operator-(class_演算子オーバーロード a,class_演算子オーバーロード b)=>new(-a.内部の値,true,a.Stringプロパティ);
    public static class_演算子オーバーロード operator&(class_演算子オーバーロード a,class_演算子オーバーロード b){
        return new(a.内部の値&b.内部の値,true,a.Stringプロパティ+b.Stringプロパティ);
    }
    [SuppressMessage("ReSharper","ConvertIfStatementToReturnStatement")]
    public static class_演算子オーバーロード operator|(class_演算子オーバーロード? a,class_演算子オーバーロード? b){
        if(a==null) return b!;
        if(b==null) return a;
        return new class_演算子オーバーロード(a.内部の値|b.内部の値,true,a.Stringプロパティ);
    }
    ...
    public static explicit operator class_演算子オーバーロード(decimal a)=>new(1,true,"abc");
...
public class ExpressionEqualityComparer:共通{
    ...
    private static readonly object Object_String="A";
    private static readonly object Object_Int32=1;
    private static readonly string[] Array={"A","B"};
    private static readonly int _Int32=2;
    private static readonly bool _Boolean=true;
    private static readonly int? _NullableInt32=0;
    private static readonly List<int> _List=new(){1,2};
