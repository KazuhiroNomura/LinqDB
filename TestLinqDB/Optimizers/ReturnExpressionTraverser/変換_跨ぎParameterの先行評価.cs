...
public class 変換_跨ぎParameterの先行評価 : 共通
{
    ...
    [Fact]
    public void 取得_先行評価式_判定_移動できるか_Parameter()
    {
        var s = new Set<int>();
    ...
    [Fact]
    public void 変換_先行評価式_MakeAssign()
    {
