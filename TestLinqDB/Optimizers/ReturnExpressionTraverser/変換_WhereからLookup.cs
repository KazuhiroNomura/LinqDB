...
public class 変換_WhereからLookup : 共通
{
    ...
    public void Call()
    {
        ...
        //            }
        this.ExpressionAssertEqual(() => s.Join(s, o => o, i => i, (o, i) => new { o, i }).Where(p => p.o==0));
        //            if(Listプローブビルド_Count>0) {
        //                if(Listプローブビルド_Count==1) {
        //                    while(true) {
        //                        if(Set1 is null) {
        this.ExpressionAssertEqual(() => s.Join(s, o => o, i => i, (o, i) => new { o, i }).Where(p => p.i==0));
        //                        }
        this.ExpressionAssertEqual(() => s.Join(s, o => o, i => i, (o, i) => new { o, i }).Where(p => p.i==0));
        ...
        this.ExpressionAssertEqual(() => st.SelectMany(o => st.Where(i => i.Key.Equals(o.Key))));
        //                            } else {
        this.ExpressionAssertEqual(() => st.SelectMany(o => st.Where(i => i.Key.メンバー11.Equals(o.Key.メンバー11))));
        //                            }
        //                        }
        //                    }
        //                } else {
        ...
        this.ExpressionAssertEqual(() => s.SelectMany(o => new int[3].Where(i => o==i&&i+1==o+1)));
        //                        } else{
        this.ExpressionAssertEqual(() => s.SelectMany(o => new int[3].Where((i, index) => o==i&&i+1==o+1&&index==0)));
        //                        }
        //                    } else{
        //                        if(typeof(Sets.ExtensionSet)==MethodCall0_Method.DeclaringType){
        ...
        this.ExpressionAssertEqual(() => s.SelectMany(o => new int[3].Where((i, index) => o==i&&i+1==o+1&&index==3)));
        ...
        //                }
        //            }
        this.ExpressionAssertEqual(() => s.Where(p => p==0));
        ...
        this.ExpressionAssertEqual(() => s.Where(p => true));
        //                    } else {
        ...
        this.ExpressionAssertEqual(() => s.Where(p => p==0));
        //        }
        this.ExpressionAssertEqual(() => st.SelectMany(o => s.Let(i => new { o, i }).i.Where(i => i==3)));
        this.ExpressionAssertEqual(() => st.SelectMany(o => s.Where(i => i==3)));
        //    }
        this.ExpressionAssertEqual(() => st.Select(o => new { o }));
        //}
        this.ExpressionAssertEqual(() => st.Let(o => new { o }));
    }
