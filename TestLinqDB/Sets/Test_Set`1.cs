...
public class Test_Set1
{
    ...
    public void SymmetricExceptWith()
    {
        ...
        Assert.Equal(new Set<int> { 0, 1, 2, 3, 4, 5, 6, 7 }, w);
    }
    [Fact]
    ...
    public void DeleteWith()
    {
        Int offset = 1L + uint.MaxValue;
        {
            ...
            }
            {
                var s = new Set<Int>(d);
                s.DeleteWith(p => p == 16);
                Assert.Equal(new Set<Int> { 0, 1, 2, 3, 17 }, s);
            }
            {
                var s = new Set<Int>(d);
                s.DeleteWith(p => p == 17);
                Assert.Equal(new Set<Int> { 0, 1, 2, 3, 16 }, s);
            }
        }
        {
            var d = new Set<Int> { 0, 1, 2, 3, 16, 16 + offset };
            {
                var s = new Set<Int>(d);
                s.DeleteWith(p => p == 16);
                Assert.Equal(new Set<Int> { 0, 1, 2, 3, 16 + offset }, s);
            }
            {
                var s = new Set<Int>(d);
    ...
    public void UnionWith()
    {
        ...
        }
        {
            ...
            Assert.Equal(new Set<Int> { 1, 2, 3, 4, 5, 6 }, d);
        }
    }
    [Fact]
