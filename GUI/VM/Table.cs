...
public class Table:DependencyObject, ITable,IDiagramObject {
    ...
    private static readonly DependencyProperty TableNameTextBox_IsReadOnlyProperty = DependencyProperty.Register(nameof(TableNameTextBox_IsReadOnly),typeof(bool),typeof(Table));
    ...
    public Table()=>this.TableNameTextBox_IsReadOnly=true;
    public Table(string Name,Schema Schema) {
        this.Name = Name;
        this.Schema = Schema;
    }
    public Table(string Name,Schema Schema,double Left,double Top):this(Name,Schema) {
        this.Left=Left;
        this.Top=Top;
    }
    public ObservableCollection<Relation> 親Relations { get; } = new();
    public ObservableCollection<Relation> 子Relations { get; } = new();
    private static readonly DependencyProperty LeftProperty = DependencyProperty.Register(nameof(Left),typeof(double),typeof(Table));
    public double Left {
    ...
    private static readonly DependencyProperty TopProperty = DependencyProperty.Register(nameof(Top),typeof(double),typeof(Table));
    public double Top {
    ...
    private static readonly DependencyProperty _Point = DependencyProperty.Register(nameof(Point),typeof(Point),typeof(Table));
    public Point Point {
        ...
        set {
            ...
            foreach(var Relation in this.親Relations) {
                共通(Relation,Relation.親Table!.Point,value);
            }
            foreach(var Relation in this.子Relations) {
                共通(Relation,value,Relation.子Table!.Point);
            }
            static void 共通(Relation Relation,Point 親_Point,Point 子_Point) {
                ...
                var 子_Columns = Relation.子Table!.Columns;
                ...
                var 親_Columns = Relation.親Table!.Columns;
