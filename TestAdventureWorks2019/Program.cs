...
using LinqDB.Sets;
using AdventureWorks2019.Tables.dbo;
using AdventureWorks2019.Tables.HumanResources;
using AdventureWorks2019.Tables.Person;
using AdventureWorks2019.Tables.Production;
...
namespace TestAdventureWorks2019 {
    abstract class Program:共通 {
        ...
        */
        ...
        //private static IOutIEnumerable<TResult> Pivot<T, TKey,TResult>(
        //    IOutIEnumerable<T> source,
        ...
        //    IOutIEnumerable<GroupingSet<TResult,T>> g3 = g;
        //    IOutIEnumerable<IGrouping<TResult,T>> g4 = g2;
        ...
        //[SuppressMessage("Performance","CA1820:文字列の長さを使用して空の文字列をテストします",Justification = "<保留中>")]
        //private static IOutIEnumerable<IGrouping<TKey,T>> Pivot<T,  TKey>(
        //    IOutIEnumerable<T> source,
        //    Func<T,String> pivotedColumnSelector,
        ...
        //    IOutIEnumerable<GroupingSet<TKey,T>> g3 = g;
        //    IOutIEnumerable<IGrouping<TKey,T>> g4 = g2;
        ...
        private static string ToString(SqlHierarchyId id){
            return $"Document={id}";
        }
