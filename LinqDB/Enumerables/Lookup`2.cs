...
public sealed class Lookup<TKey, TElement> : Set<Grouping<TKey, TElement>>, Linq.ILookup<TKey, TElement>
{
#pragma warning disable CA1823 // 使用されていないプライベート フィールドを使用しません
    ...
    /// 既定コンストラクタ
    /// </summary>
    public Lookup() => this.KeyComparer=Generic.EqualityComparer<TKey>.Default;
    /// <summary>
    /// 比較方法を指定したコンストラクタ
    /// </summary>
    /// <param name="KeyComparer">比較方法</param>
    public Lookup(Generic.IEqualityComparer<TKey> KeyComparer) => this.KeyComparer=KeyComparer;
    /// <summary>
