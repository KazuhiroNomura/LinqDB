...
public class GroupingList<TKey,TElement>:IJsonFormatter<Sets.GroupingAscList<TKey,TElement>>{
    public static readonly GroupingList<TKey,TElement> Instance=new();//リフレクションで使われる
    public void Serialize(ref Writer writer,Sets.GroupingAscList<TKey,TElement> value,O Resolver){
    ...
    public Sets.GroupingAscList<TKey,TElement> Deserialize(ref Reader reader,O Resolver){
