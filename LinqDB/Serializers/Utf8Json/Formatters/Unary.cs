...
public class Unary:IJsonFormatter<T> {
    ...
    internal static void InternalSerialize(ref Writer writer,T Unary,IJsonFormatterResolver Resolver){
        Expression.Instance.Serialize(ref writer,Unary.Operand,Resolver);
    }
    internal static void InternalSerializeType(ref Writer writer,T Unary,IJsonFormatterResolver Resolver){
        Expression.Instance.Serialize(ref writer,Unary.Operand,Resolver);
        writer.WriteValueSeparator();
        Type.Instance.Serialize(ref writer,Unary.Type,Resolver);
    }
    internal static void InternalSerializeMethod(ref Writer writer,T Unary,IJsonFormatterResolver Resolver){
        Expression.Instance.Serialize(ref writer,Unary.Operand,Resolver);
        writer.WriteValueSeparator();
        Method.Instance.SerializeNullable(ref writer,Unary.Method,Resolver);
    }
    internal static void InternalSerializeTypeMethod(ref Writer writer,T Unary,IJsonFormatterResolver Resolver){
        Expression.Instance.Serialize(ref writer,Unary.Operand,Resolver);
        writer.WriteValueSeparator();
        Type.Instance.Serialize(ref writer,Unary.Type,Resolver);
        writer.WriteValueSeparator();
