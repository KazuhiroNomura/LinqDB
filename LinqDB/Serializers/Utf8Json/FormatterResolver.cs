    ...
    public IJsonFormatter<T> GetFormatter<T>(){
        ...
        if(type.IsArray) {
            ...
            if(type.IsAnonymous()) {
                ...
                IJsonFormatter<T>?Foramatter_T;
                if((Foramatter_T=RegisterInterface(type,typeof(Sets.IGrouping       <,>),typeof(Formatters.Sets.IGrouping   <,>)))is not null) return Foramatter_T;
                if((Foramatter_T=RegisterInterface(type,typeof(System.Linq.IGrouping<,>),typeof(Formatters.Sets.GroupingList<,>)))is not null) return Foramatter_T;
                if((Foramatter_T=RegisterInterface(type,typeof(Sets.IEnumerable     < >),typeof(Formatters.Sets.IEnumerable < >)))is not null) return Foramatter_T;
        ...
        IJsonFormatter<T>? RegisterType(Type type0,Type 検索したいキーGenericTypeDefinition){
            ...
            var Formatter0=type0.GetField("InstanceUtf8Json",System.Reflection.BindingFlags.Static|System.Reflection.BindingFlags.NonPublic)!.GetValue(null)!;
            var Formatter_T=(IJsonFormatter<T>)Formatter0;
            this.DictionaryTypeFormatter.Add(typeof(T),Formatter_T);
            return Formatter_T;
        }
        IJsonFormatter<T>RegisterGeneric(Type FormatterGenericTypeDefinition){
