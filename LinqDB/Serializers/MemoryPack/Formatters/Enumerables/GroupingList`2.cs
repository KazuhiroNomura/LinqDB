...
public class GroupingList<TKey,TElement>:MemoryPackFormatter<LinqDB.Enumerables.GroupingList<TKey,TElement>>{
    public static readonly GroupingList<TKey,TElement> Instance=new();
    private GroupingList(){}
    public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer,scoped ref LinqDB.Enumerables.GroupingList<TKey,TElement>? value){
    ...
    public override void Deserialize(ref Reader reader,scoped ref LinqDB.Enumerables.GroupingList<TKey,TElement>? value){
