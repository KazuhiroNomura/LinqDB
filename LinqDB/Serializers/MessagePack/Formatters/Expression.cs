...
public class Expression:IMessagePackFormatter<T> {
    ...
    internal static void Write(ref Writer writer,T value,MessagePackSerializerOptions Resolver){
        switch(value.NodeType){
            ...
            case Expressions.ExpressionType.NewArrayInit         :NewArray    .Write(ref writer,(Expressions.NewArrayExpression   )value,Resolver);break;//this.Write(ref writer,(Expressions.Expressions.(NewArrayExpression)value,Resolver).Expressions);break;
