...
public class Binary:IMessagePackFormatter<T> {
    ...
    public T Deserialize(ref Reader reader,MessagePackSerializerOptions Resolver){
        ...
        switch(NodeType){
            ...
            //    var (Left,Right,Method)=InternalDeserializeBinaryMethod(ref reader,Resolver);
            ...
            //    var (Left,Right,IsLiftedToNull,Method)=InternalDeserializeBinaryBooleanMethod(ref reader,Resolver);
