    ...
    internal class 変換_TSqlFragment正規化:VoidTSqlFragmentTraverser {
        ...
        protected override void WithCtesAndXmlNamespaces(WithCtesAndXmlNamespaces x) {
            ...
            foreach(var CommonTableExpression in x.CommonTableExpressions) {
                ...
                foreach(var Column in CommonTableExpression.Columns)
                    QueryDerivedTable.Columns.Add(Column);
        ...
        private TableReference TableReference置換(TableReference x) {
                            ...
                            new QuerySpecification {
                                SelectElements={
                                    new SelectScalarExpression{
                                        ...
                                        ColumnName=new IdentifierOrValueExpression{Identifier=new Identifier{Value="configuration_id"}}
                                    },
                                    new SelectScalarExpression{
                                        Expression=new StringLiteral{Value="name"},
                                        ColumnName=new IdentifierOrValueExpression{Identifier=new Identifier{Value="name"}}
                                    },
                                    new SelectScalarExpression{
                                        Expression=new ConvertCall{
                                            ...
                                            Parameter=new IntegerLiteral{Value="1"}
                                        },
                                    ...
                                    new SelectScalarExpression{
                                        Expression=new StringLiteral{Value="description"},
                                        ColumnName=new IdentifierOrValueExpression{Identifier=new Identifier{Value="description"}}
                                    },
                                    new SelectScalarExpression{
                                        Expression=new ConvertCall{
                                            DataType=new SqlDataTypeReference{
                        ...
                        return 共通0("availability_replicas_internal",
                            new QuerySpecification {
                                ...
                                SelectElements={
                                    ...
                                    new SelectScalarExpression{
                                        Expression=new ColumnReferenceExpression {
                                            MultiPartIdentifier=new MultiPartIdentifier{Identifiers={new Identifier{Value="replica_metadata_id" } } }
                                        },
                                        ColumnName=new IdentifierOrValueExpression{Identifier=new Identifier{Value="internal_group_id" } }
                                    },
                                    new SelectScalarExpression {
                                        Expression=new ColumnReferenceExpression {
                                            MultiPartIdentifier=new MultiPartIdentifier{
                                                Identifiers={new Identifier{Value="replica_id" } }
                                            }
                                        },
                                        ColumnName=new IdentifierOrValueExpression{Identifier=new Identifier{Value="ag_id" } }
                                    }
                        ...
                        return 共通0("dm_hadr_internal_wsfc_ag_replicas",
                            new QuerySpecification {
                                ...
                                SelectElements={
                                    ...
                                    new SelectScalarExpression{
                                        Expression=new ColumnReferenceExpression {
                                            MultiPartIdentifier=new MultiPartIdentifier{Identifiers={new Identifier{Value="replica_id" } } }
                                        },
                                        ColumnName=new IdentifierOrValueExpression{Identifier=new Identifier{Value="ag_id" } }
                                    },
                                    new SelectScalarExpression {
                                    ...
                                    new SelectScalarExpression{
                                        Expression=new ColumnReferenceExpression {
                                            MultiPartIdentifier=new MultiPartIdentifier{Identifiers={ new Identifier{Value="replica_server_name" } } }
                                        },
                                        ColumnName=new IdentifierOrValueExpression{Identifier=new Identifier{Value="ag_replica_name" } }
                                    }
                                }
                        ...
                        return 共通0("dm_hadr_availability_replica_states",
                            new QuerySpecification {
                                ...
                                SelectElements={
                                    ...
                                    new SelectScalarExpression{
                                        Expression=new IntegerLiteral{Value="1"},
                                        ColumnName=new IdentifierOrValueExpression{Identifier=new Identifier{Value="role" } }
                                    },
                                }
                            }
                        );
                    }
                    QueryDerivedTable 共通0(string Name,QuerySpecification QuerySpecification)=>new QueryDerivedTable {
            ...
            return x;
            SelectScalarExpression 列bit(string Name)=>
                new SelectScalarExpression {
                    Expression=new IntegerLiteral { Value="1" },
                    ColumnName=new IdentifierOrValueExpression{Identifier=new Identifier{Value=Name } }
                };
