...
partial class Optimizer {
    ...
    /// }
    /// </summary>
    private sealed class 変換_KeySelectorの匿名型をValueTuple:ReturnExpressionTraverser_Quoteを処理しない {
            ...
            if(MethodCall0_Method.IsStatic) {
                ...
                if(
                    ...
                    if(keyType.IsAnonymous()) {
                        ...
                        if(MethodCall1_Arguments[2] is LambdaExpression outerKeySelector1&&MethodCall1_Arguments[3] is LambdaExpression innerKeySelector1) {
