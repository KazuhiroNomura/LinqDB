...
partial class Optimizer {
    ...
    //        public 取得_二度出現したExpression(ExpressionEqualityComparer ExpressionEqualityComparer,判定_左辺Expressionsが含まれる 判定_左辺Expressionsが含まれる){
    ...
    //        //private bool ParameterAssignのRightか;
    //        //private bool 探索停止するか;
    ...
    //            //this.ParameterAssignのRightか=false;
    //            this.Traverse(e);
    //            return this.二度出現した一度目のExpression;
    //        }
    //        protected override void Traverse(Expression Expression) {
    //            if(this.二度出現した一度目のExpression is not null)return;
    //            switch(Expression.NodeType) {
    //                case ExpressionType.Goto or ExpressionType.DebugInfo or ExpressionType.Default or ExpressionType.Label or ExpressionType.Lambda or ExpressionType.PostDecrementAssign or ExpressionType.PostIncrementAssign or ExpressionType.PreIncrementAssign or ExpressionType.PreDecrementAssign or ExpressionType.Throw:
    //                    return;
    //                case ExpressionType.Assign: {
    //                    var Assign = (BinaryExpression)Expression;
    //                    var Assign_Left = Assign.Left;
    //                    //this.Traverse(Assign_Left);
    //                    //if(Assign_Left is ParameterExpression Parameter)
    //                    //    this.判定_無効Parametersが含まれないか.Add(Parameter);
    //                    //else
    //                    //    this.Traverse(Assign_Left);
    ...
    //                    if(this.Dictionary一度出現したExpression_二度出現したExpressionの一度目.TryGetValue(Expression,out var 二度出現した一度目のExpression)) {
    //                        this.二度出現した一度目のExpression=二度出現した一度目のExpression;
    //                        return;
    //                    }
    //                    this.Dictionary一度出現したExpression_二度出現したExpressionの一度目.Add(Expression,Expression);
    //                    //ここでreturnしないのはDictionaryに複数の式を入れたいから
    //                } else {
    ...
    //            //        this.Traverse(AndAlso.Left);
    //            //        break;
    //            //    }
    //            //    case ExpressionType.OrElse: {
    //            //        var OrElse=(BinaryExpression)Expression;
    //            //        this.Traverse(OrElse.Left);
    //            //        break;
    //            //    }
    //            //    case ExpressionType.Conditional: {
    //            //        var Conditional=(ConditionalExpression)Expression;
    //            //        this.Traverse(Conditional.Test);
    //            //        if(this.二度出現した一度目のExpression is not null)break;
    ...
    //            //        this.Traverse(((SwitchExpression)Expression).SwitchValue);
    //            //        break;
    //            //    }
    //            //    default: {
    //            //        base.Traverse(Expression);
    ...
    //            //    }
    //            //}
    //            //this.ParameterAssignのRightか=ParameterAssignのRightか;
    //            base.Traverse(Expression);
    //        }
    ...
    //        public 変換_二度出現したExpression(作業配列 作業配列,ExpressionEqualityComparer_Assign_Leftで比較 ExpressionEqualityComparer_Assign_Leftで比較,判定_左辺Expressionsが含まれる 判定_左辺Expressionsが含まれる) : base(作業配列) {
    ...
    //                    switch(Assign0.Right.NodeType) {
    //                        case ExpressionType.Constant or ExpressionType.Default or ExpressionType.Parameter:
    //                            return Expression.Assign(Assign1_Left,Assign0.Right);
    //                        default: {
    //                            var Assign1_Right=this.Traverse(Assign0.Right);
    //                            this.判定_左辺Expressionsが含まれる.Add(Assign0_Left);
    //                            //if(Assign0_Left is ParameterExpression Parameter)
    //                              //  this.判定_左辺Expressionsが含まれる.Add(Parameter);
    //                            //Expression Assign1_Right;
    //                            //if(Assign0_Left is ParameterExpression Parameter) {
    //                            //    //Assign1_Right=this.Traverse(Assign0.Right);
    //                            //    this.判定_左辺Parametersが含まれないか.Add(Parameter);
    //                            //    if(this.一度目のAssign is null) {
    //                            //        this.判定_左辺Parametersが含まれないか.Add(Parameter);
    //                            //    }
    //                            //} else
    //                            //    Assign1_Right=this.Traverse(Assign0.Right);
    ...
    //            //if(Expression0==this.二度出現した一度目のExpression){
    //            //    var 一度目のAssign=this.一度目のAssign;
    //            //    if(一度目のAssign is not null) {
    //            //        this.一度目のAssign=null;
    //            //        return 一度目のAssign;
    //            //    }
    //            //    return this.判定_左辺Parametersが含まれる.実行(Expression0)?Expression0:this.二度目以降のParameter!;
    //            //    //return this.二度目以降のParameter!;
    //            //}
    //            //if(this._ExpressionEqualityComparer_Assign_Leftで比較.Equals(Expression0,this.二度出現した一度目のExpression)){
    //            //    if(this.一度目のAssign is null)
    //            //        return this.判定_左辺Parametersが含まれる.実行(Expression0)?Expression0:this.二度目以降のParameter!;
    //            //}
    ...
    //        this._取得_二度出現したExpression=new(ExpressionEqualityComparer_Assign_Leftで比較,判定_左辺Parametersが含まれる);
    //        this._変換_二度出現したExpression=new(作業配列,ExpressionEqualityComparer_Assign_Leftで比較,判定_左辺Parametersが含まれる);
    ...
    //    protected override Expression Assign(BinaryExpression Binary0)=>Expression.Assign(
    ...
    //        var ListスコープParameter1=this.ListスコープParameter;
    //        var ListスコープParameterCount = ListスコープParameter1.Count;
    //        var 取得_二度出現したExpression = this._取得_二度出現したExpression;
    //        var 変換_旧Expressionを新Expressionに二度置換 = this._変換_二度出現したExpression;
    //        while(true) {
    //            var 二度出現した一度目のExpression=取得_二度出現したExpression.実行(Lambda1_Body);
    //            if(二度出現した一度目のExpression is null)break;
    //            var Variable = Expression.Variable(二度出現した一度目のExpression.Type,$"局所{this.番号++}");
    //            //this.ListローカルParameter.Add(Variable);
    //            BlockVariables.Add(Variable);
    //            ListスコープParameter1.Add(Variable);
    //            var e0 =変換_旧Expressionを新Expressionに二度置換.実行(Lambda1_Body,二度出現した一度目のExpression,Variable);
    //            Lambda1_Body=e0;
    //        }
    //        ListスコープParameter1.RemoveRange(ListスコープParameterCount,ListスコープParameter1.Count-ListスコープParameterCount);
    //        //var Lambda1_Body = E;
    ...
    //        ListスコープParameter.RemoveRange(ListスコープParameter_Count,Lambda0_Parameters.Count);
    //        return Lambda1;
    //    }
    //}
    private sealed class 変換_局所Parameterの先行評価:ReturnExpressionTraverser_Quoteを処理しない {
        ...
        private sealed class 取得_二度出現したExpression:VoidExpressionTraverser_Quoteを処理しない{
            ...
            private readonly Dictionary<Expression,Expression?> Dictionary一度出現したExpression_二度出現したExpressionの一度目;
            private HashSet<Expression> HashSet一度出現したExpression;
            //private HashSet<Expression> HashSet一度出現したExpression2;
            private readonly ExpressionEqualityComparer ExpressionEqualityComparer;
            private readonly 判定_左辺Expressionsが含まれる 判定_左辺Expressionsが含まれる;
            //private readonly Stack<bool> Stack_IfTrueまたはIfFalse外部か=new();
            ...
            //private readonly 取得_Labelに対応するExpressions 取得_Labelに対応するExpressions;
            public 取得_二度出現したExpression(IReadOnlyDictionary<LabelTarget,List<Expression>>Dictionary_LabelTarget_Expressions,ExpressionEqualityComparer ExpressionEqualityComparer,判定_左辺Expressionsが含まれる 判定_左辺Expressionsが含まれる){
                //this.取得_Labelに対応するExpressions=new(Dictionary_LabelTarget_Expressions);
                this.Dictionary_LabelTarget_Expressions=Dictionary_LabelTarget_Expressions;
                this.判定_左辺Expressionsが含まれる=判定_左辺Expressionsが含まれる;
                this.Dictionary一度出現したExpression_二度出現したExpressionの一度目=new(ExpressionEqualityComparer);
                this.HashSet一度出現したExpression=new HashSet<Expression>(ExpressionEqualityComparer);
                //this.HashSet一度出現したExpression2=new HashSet<Expression>(ExpressionEqualityComparer);
                this.ExpressionEqualityComparer=ExpressionEqualityComparer;
            }
            internal IEnumerable<Expression> ラムダ跨ぎParameters=default!;
            private bool IfTrueまたはIfFalse外部か;
            ...
            public (Expression? Expression,bool フローを走査した)実行(Expression e){
                ...
                this.判定_左辺Expressionsが含まれる.Clear();
                //this.ParameterAssignのRightか=false;
                //this.取得_Labelに対応するExpressions.実行(e);
                this.Traverse(e);
            ...
            protected override void Traverse(Expression Expression) {
                ...
                switch(Expression.NodeType) {
                    ...
                    case ExpressionType.Assign: {
                        ...
                        this.Traverse(Assign.Right);
                        var Assign_Left = Assign.Left;
                        if(Assign_Left is not ParameterExpression)
                            this.Traverse(Assign_Left);
                        this.判定_左辺Expressionsが含まれる.Add(Assign_Left);
                        return;
                        //↓自動局所変数設定でうまくいかない例えば
        ...
        protected override Expression Lambda(LambdaExpression Lambda0){
            ...
            //var ListスコープParameter1 = this.ListスコープParameter;
            //var ListスコープParameterCount = ListスコープParameter1.Count;
            //var 取得_Labelに対応するExpressions=this._取得_Labelに対応するExpressions;
            var 取得_二度出現したExpression = this._取得_二度出現したExpression;
            var 変換_旧Expressionを新Expressionに二度置換 = this._変換_二度出現したExpression;
            while(true) {
                //取得_Labelに対応するExpressions.実行(Lambda1_Body);
            ...
            var Lambda1 = Expression.Lambda(Lambda0.Type,Lambda2_Body,Lambda0.Name,Lambda0.TailCall,Lambda0_Parameters);
            ListスコープParameter.RemoveRange(ListスコープParameter_Count,ListスコープParameter.Count-ListスコープParameter_Count);
            //var Lambda1 = Expression.Lambda(Lambda0.Type,this.共通(Lambda0.Body),Lambda0.Name,Lambda0.TailCall,Lambda0_Parameters);
            //ListスコープParameter.RemoveRange(ListスコープParameter_Count,Lambda0_Parameters.Count);
            return Lambda1;
        }
        private Expression 共通(Expression Expression0){
            ...
            //ListスコープParameter.RemoveRange(ListスコープParameter_Count,ListスコープParameter.Count-ListスコープParameter_Count);
            //var Lambda1_Body = E;
            var Expression2 = this.Traverse(Expression0);
            //var Expression3=this._変換_フロー.実行(Expression2);
            //if(Block_Variables.Count>0)Expression3=Expression.Block(Block_Variables,this._作業配列.Expressions設定(Expression3));
            return Expression2;
        }
        protected override Expression Conditional(ConditionalExpression Conditional0){
            ...
            var Conditional1_IfTrue=this.共通(Conditional0_IfTrue);
            var Conditional1_IfFalse=this.共通(Conditional0_IfFalse);
