...
public sealed partial class Optimizer:IDisposable{
    ...
    /// </summary>
    internal abstract class VoidExpressionTraverser_Quoteを処理しない:VoidExpressionTraverser.VoidExpressionTraverser {
    ...
    private readonly Microsoft.SqlServer.TransactSql.ScriptDom.TSql160Parser Parser = new(true);
    ...
    private Optimizer(Type BaseType) {
        var 作業配列 = this._作業配列;
        var ScriptGenerator = new Microsoft.SqlServer.TransactSql.ScriptDom.Sql160ScriptGenerator(
    ...
    private Microsoft.SqlServer.TransactSql.ScriptDom.TSqlFragment SQLからTSqlFragment(string SQL) {
