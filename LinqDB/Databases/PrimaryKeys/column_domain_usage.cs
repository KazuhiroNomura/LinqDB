...
[Serializable]
public struct column_domain_usage:IEquatable<column_domain_usage> {
    ...
    public column_domain_usage(string domain_catalog,string domain_schema,string domain_name,string table_catalog,string table_schema,string table_name) {
