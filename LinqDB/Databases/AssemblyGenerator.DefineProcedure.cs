...
public partial class AssemblyGenerator {
    private void DefineProcedure(IProcedure Object,ModuleBuilder ModuleBuilder,TypeBuilder Container_TypeBuilder,TypeBuilder Schema_TypeBuilder,ILGenerator Schema_ctor_I,LocalBuilder Schema_ToString_sb,ILGenerator Schema_ToString_I) {
        const string Disp_Name = "DispProcedure",Impl_Name = "ImplProcedure";
        //1 V,TF
        //2 T,V,TF,SF
        ...
        this.Dictionary_Procedure.Add(Object,new(
            Disp_TypeBuilder,
            Disp_ctor_I,
            Impl_TypeBuilder,
